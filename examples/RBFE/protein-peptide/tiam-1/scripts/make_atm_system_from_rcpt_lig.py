...
parser.add_argument('--LIG1PDBinFile',  required=True,  type=str, default=None,
                    help='PDB file of first peptide')
...
# Optional input
parser.add_argument('--LIG2PDBinFile',  required=False,  type=str, default=None,
                    help='PDB file of second ligand')
...
parser.add_argument('--implicitSolvent', required=False, type=str,
                    default='None',
                    help='Implicit solvent to use: HCT OBC2 GBn2')
...
if rbfe:
    lig2pdbfile  = args['LIG2PDBinFile']
...
print('Ligand 1 file name:                 ', lig1pdbfile)
if rbfe:
    print('Ligand 2 file name:                 ', lig2pdbfile)
...
print('Read peptide 1:')
lig1pdb = PDBFile(lig1pdbfile)
...
for at in lig1_ommtopology.atoms():
    print(at.id, at.residue.chain.id) 
nlig1 = lig1_ommtopology.getNumAtoms()
print('Number of atoms in peptide 1:', nlig1)
print('Call Modeller: include peptide 1')
...
if not rbfe:
    ...
    print('Read peptide 2:')
    lig2pdb = PDBFile(lig2pdbfile)
    ...
    print('Number of atoms in peptide 2:', nlig2)
    for i in range(nlig2):
        lig2_positions[i] += displacement
    print('Call Modeller: include peptide 2')
...
for at in modeller.topology.atoms():
    if at.residue.chain.id == chainname_lig1:
