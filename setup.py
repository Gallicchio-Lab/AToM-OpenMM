...
MODULES = 'async_re', 'date_async_re', 'openmm_async_re', 'bedam_async_re', 'bedamtempt_async_re', 'tempt_async_re', 'temptcmplx_async_re.py', 'gibbs_sampling', 'ssh_transport', 'boinc_transport', 'local_openmm_transport', 'ommreplica', 'abfe_explicit.py', 'rbfe_explicit.py'
