...
SCRIPTS = 'abfe_production.py', 'rbfe_production.py', 'abfe_structprep.py', 'rbfe_structprep.py', 'rbfe_explicit_sync.py', 'make_atm_system_from_pdb.py', 'make_atm_system_from_Amber.py', 'make_atm_system_from_rcpt_lig.py'
