    ...
    def setupJob(self):
        with Timer(self.logger.info, "ATM setup"):
            ...
            with Timer(self.logger.info, "create system"):
                ...
                ommsystem = OMMSystemABFE(self.basename, self.config, pdbtopfile, systemfile, self.logger)
